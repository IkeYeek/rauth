...
impl Group {
    ...
    pub(crate) fn get_all(db: &mut SqliteConnection) -> Result<Vec<Group>, ApiError> {
    ...
    pub(crate) fn get(db: &mut SqliteConnection, group_id: i32) -> Result<Group, ApiError> {
        match crate::schema::groups::dsl::groups
